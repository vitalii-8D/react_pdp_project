...
type CreateRoomActionData = { error: string } | { ok: true } | undefined;

interface ChatRoomListProps {
  title: string;
  subtitle: string;
  rooms: ChatRoomEntity[];
  directRooms: ChatRoomEntity[];
  currentUserId: string;
  isAdmin: boolean;
  actionData: CreateRoomActionData;
...
// Shared by chat.tsx (Socket.IO) and chat-v2.tsx (GraphQL subscriptions) - the two transports
// render an identical room list / DM search / room-creation form, differing only in copy, the
// room link target, and the resource routes UserSearch posts to.
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <UserSearch searchAction={searchAction} startDmAction={startDmAction} />
